...
import { blockRouterMetaData as blockRouterMetaData121220231 } from './Exercise-example-12-12-2023/router-data';
...
import { blockRouterMetaData as ArrayRenderToTableBlockRouterMetaData } from './ArrayRenderToTable/router-data';
import { blockRouterMetaData as ArrayRenderingBlockRouterMetaData } from './ArrayRendering/router-data';
import { blockRouterMetaData as BoxModelBlockRouterMetaData } from './BoxModel/router-data';
import { blockRouterMetaData as HtmlTablesBlockRouterMetaData } from './HtmlTables/router-data';
...
export const blockRouterMetaData = [
  ...
  ArrayRenderToTableBlockRouterMetaData,
  ArrayRenderingBlockRouterMetaData,
  BoxModelBlockRouterMetaData,
  HtmlTablesBlockRouterMetaData,
